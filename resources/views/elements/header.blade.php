            ...
            <div class="d-flex align-items-stretch flex-shrink-0">
                ...
                <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click"
                        ...
                        <img alt="pic" src="{{ auth()->user()->avatar != null ? auth()->user()->avatar : asset('public/assets/media/avatars/blank.png')  }}" />
                    </div>
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                                ...
                                <div class="d-flex flex-column">
                                    <div class="fw-bold d-flex align-items-center fs-5"> {{ auth()->user()->name }}
                                        <span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">{{
                                            auth()->user()->role_id == 1 ? "Admin" : "User" }}</span>
                                    </div>
                        ...
                        <div class="menu-item px-5">
                            ...
                            <a class="menu-link px-5 text-danger" href="{{ route('logout') }}" onclick="event.preventDefault();
